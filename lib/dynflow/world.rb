  ...
  class World
    ...
    def terminate(future = Future.new)
      @termination_barrier.synchronize do
        ...
        Future.join([@dispatcher_terminated,
                     @executor_terminated].compact, future)
      end
    end
